...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="<?php echo route_to('dashboard'); ?>" target="_blank">
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo url_is(route_to('admin.vagas.index')) ? 'active' : '' ;?> "
                        href="<?php echo route_to('admin.vagas.index'); ?>">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="<?php echo route_to('admin.candidatos.index'); ?>">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Currículos</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="<?php echo route_to('admin.news.index'); ?>">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a class="nav-link  " target="_blank" href="<?php echo base_url(); ?>">
                        ...
                        <span class="nav-link-text ms-1">Acessar Site</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <?php 
        // Verificar se a variável breadcrumb existe e não está vazia
        ...
        ?>
                        ...
                        <li class="breadcrumb-item text-sm">
                            <a class="opacity-5 text-dark" href="<?= $item['url'] ?>">
                                <?= $item['title'] ?>
                            </a>
                        </li>
                        <?php endif; ?>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                <a href="https://www.fredericomoura.com.br" class="font-weight-bold"
                                    target="_blank">Frederico Moura</a>.
                            </div>
                        </div>
