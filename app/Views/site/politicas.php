            ...
            <div class="container">
                <div class="privacy-content">
                    ...
                    <div class="privacy-section">
                        ...
                        <p>Ao se cadastrar em nosso site para concorrer a vagas de estágio, poderemos coletar os
                            seguintes dados pessoais:</p>
                        <ul>
                            <li>Nome completo;</li>
                    ...
                    <div class="privacy-section">
                        ...
                        <ul>
                            ...
                            <li>Eventualmente, enviar informações sobre novas oportunidades de estágio, mediante
                                consentimento do candidato.</li>
                        </ul>
                    </div>
                    ...
                    <div class="privacy-section">
                        ...
                        <ul>
                            ...
                            <li>Empresas concedentes de estágio, exclusivamente para análise de perfil e participação em
                                processos seletivos;</li>
                    ...
                    <div class="privacy-section">
                        ...
                        <ul>
                            <li>Art. 7º, inciso V da LGPD – quando necessário para execução de contrato ou de
                                procedimentos preliminares relacionados a contrato do qual o titular seja parte
                                (processo seletivo de estágio);</li>
                    ...
                    <div class="privacy-section">
                        ...
                        <p>Os dados serão armazenados em ambiente seguro, com medidas técnicas e administrativas
                            adequadas para proteger contra acessos não autorizados, perda, alteração ou divulgação
                            indevida.</p>
                    </div>
                    ...
                    <div class="privacy-section">
                        ...
                        <ul>
                            ...
                            <li>Pelo prazo máximo de 12 meses após o cadastro, para contato em futuras oportunidades,
                                salvo manifestação contrária do candidato.</li>
                        </ul>
                        <p>Após esse período, os dados poderão ser eliminados ou anonimizados, salvo obrigação legal de
                            retenção.</p>
                    </div>

                    <div class="privacy-section">
                        <h2>7. Direitos do titular</h2>
                        <p>O candidato pode, a qualquer momento e de forma gratuita, exercer seus direitos previstos na
                            LGPD, como:</p>
                        <ul>
                        ...
                        <p>Para exercer seus direitos, o candidato deve entrar em contato pelo e-mail: <a
                                href="mailto:contato@belottis.com.br">contato@belottis.com.br</a>.</p>
                    </div>

                    <div class="privacy-section">
                        <h2>8. Alterações nesta política</h2>
                        <p>Esta Política poderá ser atualizada a qualquer momento para refletir melhorias ou mudanças
                            legais. Recomendamos consulta periódica em nosso site.</p>
                    </div>

                    <div class="privacy-section">
                        <h2>9. Encarregado de Proteção de Dados (DPO)</h2>
                        <p>Em caso de dúvidas, solicitações ou exercício de direitos relacionados ao tratamento de dados
                            pessoais, o candidato pode entrar em contato com nosso Encarregado de Proteção de Dados no
                            e-mail: <a href="mailto:contato@belottis.com.br">contato@belottis.com.br</a>.</p>
                    </div>
