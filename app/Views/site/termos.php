            ...
            <div class="container">
                <div class="terms-content">
                    <div class="terms-section">
                        ...
                        <p>Ao acessar e utilizar os serviços da Belottis, você concorda em cumprir e estar vinculado a estes Termos de Uso. Se você não concordar com qualquer parte destes termos, não deverá utilizar nossos serviços.</p>
                        <p>Estes Termos de Uso regulam o uso deste site e todos os serviços oferecidos pela Belottis, incluindo recrutamento, seleção e intermediação de oportunidades de emprego e estágio.</p>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <ul>
                            <li><strong>Belottis:</strong> Empresa de recrutamento e seleção, provedora dos serviços</li>
                            <li><strong>Usuário/Candidato:</strong> Pessoa física que utiliza os serviços da plataforma</li>
                            <li><strong>Empresa Cliente:</strong> Organização que contrata os serviços da Belottis</li>
                            <li><strong>Serviços:</strong> Todas as funcionalidades oferecidas através do site e plataformas relacionadas</li>
                        </ul>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <p>Todos os direitos de propriedade intelectual relacionados à plataforma, incluindo software, design, logotipos, marcas e conteúdo, são de propriedade exclusiva da Belottis ou de seus licenciadores.</p>
                        
                        <h3>6.2. Conteúdo do usuário</h3>
                        <p>Ao enviar conteúdo para nossa plataforma, você concede à Belottis uma licença mundial, não exclusiva e isenta de royalties para usar, reproduzir, modificar e exibir tal conteúdo para os fins de prestação dos serviços.</p>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <p>O tratamento de dados pessoais é regido pela nossa <a href="<?php echo route_to('site.politicas');?>" title="Política de Privacidade">Política de Privacidade</a>, que faz parte integrante destes Termos de Uso.</p>
                        <p>Ao utilizar nossos serviços, você consente com a coleta, uso e compartilhamento de suas informações pessoais conforme descrito em nossa Política de Privacidade.</p>
                    </div>

                    <div class="terms-section">
                        <h2>9. Modificações nos Termos</h2>
                        <p>A Belottis se reserva o direito de modificar estes Termos de Uso a qualquer momento. As alterações entrarão em vigor após a publicação na plataforma.</p>
                        <p>O uso continuado dos serviços após tais modificações constitui aceitação dos novos termos. Recomendamos que você revise periodicamente estes Termos de Uso.</p>
                    </div>

                    <div class="terms-section">
                        <h2>10. Rescisão</h2>
                        <p>Estes Termos de Uso permanecerão em vigor enquanto você utilizar nossos serviços. A Belottis pode suspender ou encerrar seu acesso:</p>
                        <ul>
                    ...
                    <div class="terms-section">
                        ...
                        <h3>11.2. Foro</h3>
                        <p>Fica eleito o foro da comarca de Guarulhos/SP para dirimir qualquer questão relacionada a estes termos, com renúncia expressa a qualquer outro.</p>
                        
                        <h3>11.3. Tolerância</h3>
                        <p>O não exercício de qualquer direito ou disposição destes Termos de Uso não constituirá renúncia a tal direito ou disposição.</p>
                    </div>
                    ...
                    <div class="terms-section">
                        ...
                        <strong>Telefone:</strong> (11) 2600-1607</p>
